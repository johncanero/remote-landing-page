...
export default function Example() {
  return (
    <Menu as="div" className=" relative inline-block text-left">
      <div>
        <Menu.Button className="ml-12 inline-flex w-full bg-white md:ml-6 py-2 text-base font-Poppins font-medium text-gray-600 hover:text-gray-800">
            Features
      ...
      >
        <Menu.Items className="absolute z-10 mt-2 w-36 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
            <Menu.Item>
              {({ active }) => (
                <a
